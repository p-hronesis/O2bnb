...
const RentModal = () => {
  ...
  if (step === STEPS.LOCATION) {
    bodyContent = (
      <div className="flex flex-col gap-6">
        <Heading title="Where is your place located?" subtile="Help guests find you!" />
        <CountrySelect
          value={location}
  ...
  if (step === STEPS.PRICE) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading title="Now set your price" subtile="How much to you charge per night?" />
        <Input
          id="price"
          label="Price"
          formatPrice
